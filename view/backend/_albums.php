...
<div class="col-md-12" id="AlbumContent">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-3 albums">
            <a href="#" data-toggle="tooltip" title="<?php echo esc($albums['description']) ?>" class="thumbnail">
            ...
            <div class="caption">
                <h3><?php  echo esc($albums['name']); ?></h3>
                ...
                <div class="btn-group pull-left col-md-offset-1">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo ipActionUrl(array('aa'=>'ImageAlbum.attach','id'=>$albums['id'])) ?>">Add Images</a></li>
                        <li><a href="<?php echo ipActionUrl(array('aa'=>'ImageAlbum.albumcover','id'=>$albums['id'])) ?>">Choose Album Cover</a></li>
