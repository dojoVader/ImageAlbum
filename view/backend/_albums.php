    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-3">
            ...
            <div class="caption">
                ...
                <p><a href="#" class="btn btn-primary" role="button">Delete</a> <a href="<?php echo ipActionUrl(array('aa'=>'ImageAlbum.attach','id'=>$albums['id'])) ?>" class="btn btn-default" role="button">Add Images</a></p>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
